                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(lodash_1.map(this.store[name], function (config) { return __awaiter(_this, void 0, void 0, function () {
                                var key, option, exec, _a, series, parallel, action, action;
                                var _this = this;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 2:
                                            ...
                                            action = gulp_1.series.apply(void 0, series.concat([exec]));
                                            if (option.option && option.option.description) {
                                                action.description = option.option.description;
                                            }
                                            return [4 /*yield*/, gulp_1.default.task(key, action)];
                                        case 3: return [2 /*return*/, _b.sent()];
                                        case 4:
                                            if (!parallel) return [3 /*break*/, 6];
                                            action = gulp_1.parallel.apply(void 0, parallel.concat([exec]));
                                            if (option.option && option.option.description) {
                                                action.description = option.option.description;
                                            }
                                            return [4 /*yield*/, gulp_1.default.task(key, action)];
                                        ...
                                        case 7:
                                            if (option.option && option.option.description) {
                                                exec.description = option.option.description;
                                            }
                                            return [4 /*yield*/, gulp_1.default.task(key, exec)];
